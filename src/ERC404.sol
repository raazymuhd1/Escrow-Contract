...
abstract contract ERC404 is Ownable {
    ...
    function _transfer(
        ...
        // this lines tells the dont check this code, it wont be overflowed/underflowed ( and will safe gas bcoz the compiler will not perform a check on this lines of code )
        unchecked {
            balanceOf[to] += amount;
        }
        
        if (!whitelist[from]) {
            // example 100 erc404 / unit (18 decimals) - ( balanceFromAfter ( 40 ) / unit (18 decimals) ) = 100 - 40 = 60
